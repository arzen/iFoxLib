...
public class LoadingDynamic extends BaseDynamic {
	public static final String TAG = "LoadingDynamic";
	...
	public View onCreateView(Activity activity) {
		mLoadingView = LayoutInflater.from(activity).inflate(R.layout.fragment_login_loading, null);
		return mLoadingView;
	}
